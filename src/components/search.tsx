...
export const SearchBar = ()=>{
  ...
  return(
    ...
    <input className="md:w-80  outline-none rounded bg-opacity-80 bg-purple-100 placeholder-purple-600   p-2 w-screen" value={input} placeholder="search..." onChange={(e:any)=>setInput(e.target.value)}/> 
    { input!==""&&(
